 ...
 <?php
    ...
    <section class="content">
    	<div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="post">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <p>Select the Company you want to search the jobs</p>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <select name="company[]" class="form-control show-tick" data-live-search="true">
                                        <?php
                                            $sql_company = "SELECT * FROM company";
                                            $result_companny = mysqli_query($dblink, $sql_company);

                                            while ($data_company = mysqli_fetch_array($result_companny)) {

                                        ?>
                                        <option <?php echo "value=\"".$data_company['id']."\""; ?>><?php echo $data_company['company_name']; ?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                        <button name="search_company_jobs" class="btn btn-primary waves-effect" type="submit">SEARCH</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <!-- #END# Input -->
            <?php
                if (isset($_POST['search_company_jobs'])) {
            ?>
                                        ...
                                        <?php
                                            ...
                                            if (isset($_POST['company'])) {
                                                foreach ($_POST['company'] as $company) {
                                                    $sql_active_job = "SELECT * FROM job WHERE company_id = '$company'";
